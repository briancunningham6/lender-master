...
db.open(function(err, db) {
    if(!err) {
        ...
        db.collection('spirits', {safe:true}, function(err, collection) {
            if (err) {
                console.log("The 'spirits' collection doesn't exist. Creating it with sample data...");
                populateDB();
            }
        });
    }
...
exports.findById = function(req, res) {
    ...
    db.collection('spirits', function(err, collection) {
...
exports.addSpirit = function(req, res) {
    var wine = req.body;
...
exports.updateSpirit = function(req, res) {
    var id = req.params.id;
    var wine = req.body;
    delete wine._id;
...
exports.deleteSpirit = function(req, res) {
    var id = req.params.id;
...
var populateDB = function() {
    ...
    db.collection('spirits', function(err, collection) {
        collection.insert(spirits, {safe:true}, function(err, result) {});
    });
